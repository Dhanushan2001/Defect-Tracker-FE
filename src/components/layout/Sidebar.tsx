...
export const Sidebar: React.FC = () => {
  ...
  const navigation = [
    ...
    { name: "Employees", href: "/employees", icon: Users, show: can.employee.view },
    { name: "Bench", href: "/bench", icon: UserCheck, show: can.bench.view },
    { name: "Configurations", href: "/configurations", icon: Settings, show: !!(
